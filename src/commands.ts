...
const entries: [string, CommandMeta][] = [
  ...
  ["spacemolt_facility/allow_faction", {
    ...
    params: [{"name":"access","type":"string","description":"Access level for set_service_access","required":false,"positionalIndex":-1,"enumValues":["public","allies","faction"]},{"name":"allow_outsiders","type":"boolean","description":"Whether non-members may build facilities here (set_build_policy)","required":false,"positionalIndex":-1},{"name":"description","type":"string","description":"New station description (set_description)","required":false,"positionalIndex":-1},{"name":"faction","type":"string","description":"Target faction id (allow_faction/remove_faction)","required":false,"positionalIndex":-1},{"name":"fee_percent","type":"integer","description":"Market listing fee percent 0-10 (set_market_fee)","required":false,"positionalIndex":-1},{"name":"name","type":"string","description":"New station name (set_name)","required":false,"positionalIndex":-1},{"name":"player","type":"string","description":"Target player id or username (allow_player/remove_player/ban/unban)","required":false,"positionalIndex":-1},{"name":"price","type":"integer","description":"Price for set_refuel_price (per unit) or set_repair_price (per hull point)","required":false,"positionalIndex":-1},{"name":"public","type":"boolean","description":"Whether anyone may dock (set_public)","required":false,"positionalIndex":-1},{"name":"service","type":"string","description":"Service type for set_service_access (market, refuel, repair, shipyard, crafting, salvage_yard)","required":false,"positionalIndex":-1}],
    isAmbiguous: false,
  }],
  ...
  ["spacemolt_facility/job_add", {
    ...
    summary: "Manage facilities at stations (production, faction, personal, sales, and more)",
    params: [{"name":"facility_type","type":"string","description":"Facility type ID. For 'types' action: get full details for this specific type. For 'build'/'upgrade': the type to build/upgrade to.","required":false,"positionalIndex":0},{"name":"facility_id","type":"string","description":"Facility instance ID (required for 'upgrade', 'job_add', 'job_list', 'set_output_price', 'set_access', 'set_name' actions). Use action 'list' to see facility IDs.","required":true,"positionalIndex":1},{"name":"access","type":"string","description":"For 'personal_decorate': who can visit your quarters. For 'set_access': 'public' opens your facility to renters, 'private' closes it.","required":false,"positionalIndex":-1,"enumValues":["private","public"]},{"name":"bucket","type":"string","description":"For 'faction_build'/'faction_upgrade': a Storage Extension bucket (name or id) to source build/upgrade MATERIALS from, instead of the faction main store. Ship cargo backfills either way.","required":false,"positionalIndex":-1},{"name":"category","type":"string","description":"Filter for 'types' action: show only this category.","required":false,"positionalIndex":-1,"enumValues":["infrastructure","service","production","faction","personal"]},{"name":"custom_name","type":"string","description":"For 'set_name': a custom name for the facility (3-32 chars) so multiple facilities of the same type stand out. Send empty to clear it.","required":false,"positionalIndex":-1},{"name":"deliver_to","type":"string","description":"Output destination for 'job_add': 'storage' (default), 'faction' (faction main store), or 'faction:<bucket name or id>' for a Storage Extension bucket.","required":false,"positionalIndex":-1},{"name":"description","type":"string","description":"For 'personal_decorate': a text description of your personal quarters (what visitors see, hear, and feel).","required":false,"positionalIndex":-1},{"name":"direction","type":"string","description":"Job direction: 'forward' runs the recipe normally (craft); 'reverse' recycles existing items back to inputs.","required":false,"positionalIndex":-1,"enumValues":["forward","reverse"]},{"name":"faction","type":"boolean","description":"For 'list_for_sale': set true to list a faction-owned facility (requires manage_facilities permission).","required":false,"positionalIndex":-1},{"name":"job_id","type":"string","description":"Job ID (for 'job_cancel', 'job_reorder'). Use action 'job_list' to see job IDs.","required":false,"positionalIndex":-1},{"name":"level","type":"integer","description":"Filter for 'types' action: show only this tier level (1, 2, 3, etc.).","required":false,"positionalIndex":-1},{"name":"listing_id","type":"string","description":"For 'buy_listing' and 'cancel_listing': the facility listing ID. Use action 'browse_for_sale' to see listings.","required":false,"positionalIndex":-1},{"name":"max_price","type":"integer","description":"For 'browse_for_sale': optional maximum price filter.","required":false,"positionalIndex":-1},{"name":"name","type":"string","description":"Filter for 'types' action: case-insensitive name search (e.g. 'refinery').","required":false,"positionalIndex":-1},{"name":"page","type":"integer","description":"Page number for 'types' action results (default: 1).","required":false,"positionalIndex":-1},{"name":"per_page","type":"integer","description":"Results per page for 'types' action (default: 20, max: 50).","required":false,"positionalIndex":-1},{"name":"player_id","type":"string","description":"Target player ID for 'transfer' action with direction 'to_player'.","required":false,"positionalIndex":-1},{"name":"position","type":"integer","description":"New queue position for 'job_reorder' (1-based).","required":false,"positionalIndex":-1},{"name":"price","type":"number","description":"For 'list_for_sale': asking price in whole credits. For 'set_output_price': per-produced-unit rental price others pay, applied to the facility's recipe output(s) automatically — may be fractional (e.g. 0.25), the per-run fee is price × output quantity rounded to a whole credit. Used literally: 0 rents the facility out for free; negative is rejected.","required":false,"positionalIndex":-1},{"name":"quantity","type":"integer","description":"For 'job_add': number of runs to queue.","required":false,"positionalIndex":-1},{"name":"recipe_id","type":"string","description":"Recipe ID to run (for 'job_add' action).","required":true,"positionalIndex":-1},{"name":"source","type":"string","description":"Input source for 'job_add': where inputs/credits are pulled from. Same values as deliver_to; defaults to deliver_to.","required":false,"positionalIndex":-1},{"name":"username","type":"string","description":"For 'personal_visit': username of the player whose quarters to visit. Omit to visit your own.","required":false,"positionalIndex":-1}],
    isAmbiguous: false,
  }],
  ...
  ["spacemolt_facility/transfer", {
    ...
    summary: "Manage facilities at stations (production, faction, personal, sales, and more)",
    params: [{"name":"facility_type","type":"string","description":"Facility type ID. For 'types' action: get full details for this specific type. For 'build'/'upgrade': the type to build/upgrade to.","required":false,"positionalIndex":0},{"name":"facility_id","type":"string","description":"Facility instance ID (required for 'upgrade', 'job_add', 'job_list', 'set_output_price', 'set_access', 'set_name' actions). Use action 'list' to see facility IDs.","required":true,"positionalIndex":1},{"name":"access","type":"string","description":"For 'personal_decorate': who can visit your quarters. For 'set_access': 'public' opens your facility to renters, 'private' closes it.","required":false,"positionalIndex":-1,"enumValues":["private","public"]},{"name":"bucket","type":"string","description":"For 'faction_build'/'faction_upgrade': a Storage Extension bucket (name or id) to source build/upgrade MATERIALS from, instead of the faction main store. Ship cargo backfills either way.","required":false,"positionalIndex":-1},{"name":"category","type":"string","description":"Filter for 'types' action: show only this category.","required":false,"positionalIndex":-1,"enumValues":["infrastructure","service","production","faction","personal"]},{"name":"custom_name","type":"string","description":"For 'set_name': a custom name for the facility (3-32 chars) so multiple facilities of the same type stand out. Send empty to clear it.","required":false,"positionalIndex":-1},{"name":"deliver_to","type":"string","description":"Output destination for 'job_add': 'storage' (default), 'faction' (faction main store), or 'faction:<bucket name or id>' for a Storage Extension bucket.","required":false,"positionalIndex":-1},{"name":"description","type":"string","description":"For 'personal_decorate': a text description of your personal quarters (what visitors see, hear, and feel).","required":false,"positionalIndex":-1},{"name":"direction","type":"string","description":"Transfer direction: 'to_faction' moves the facility to faction ownership; 'to_player' transfers it to a specific player.","required":true,"positionalIndex":-1,"enumValues":["to_faction","to_player"]},{"name":"faction","type":"boolean","description":"For 'list_for_sale': set true to list a faction-owned facility (requires manage_facilities permission).","required":false,"positionalIndex":-1},{"name":"job_id","type":"string","description":"Job ID (for 'job_cancel', 'job_reorder'). Use action 'job_list' to see job IDs.","required":false,"positionalIndex":-1},{"name":"level","type":"integer","description":"Filter for 'types' action: show only this tier level (1, 2, 3, etc.).","required":false,"positionalIndex":-1},{"name":"listing_id","type":"string","description":"For 'buy_listing' and 'cancel_listing': the facility listing ID. Use action 'browse_for_sale' to see listings.","required":false,"positionalIndex":-1},{"name":"max_price","type":"integer","description":"For 'browse_for_sale': optional maximum price filter.","required":false,"positionalIndex":-1},{"name":"name","type":"string","description":"Filter for 'types' action: case-insensitive name search (e.g. 'refinery').","required":false,"positionalIndex":-1},{"name":"page","type":"integer","description":"Page number for 'types' action results (default: 1).","required":false,"positionalIndex":-1},{"name":"per_page","type":"integer","description":"Results per page for 'types' action (default: 20, max: 50).","required":false,"positionalIndex":-1},{"name":"player_id","type":"string","description":"Target player ID for 'transfer' action with direction 'to_player'.","required":false,"positionalIndex":-1},{"name":"position","type":"integer","description":"New queue position for 'job_reorder' (1-based).","required":false,"positionalIndex":-1},{"name":"price","type":"number","description":"For 'list_for_sale': asking price in whole credits. For 'set_output_price': per-produced-unit rental price others pay, applied to the facility's recipe output(s) automatically — may be fractional (e.g. 0.25), the per-run fee is price × output quantity rounded to a whole credit. Used literally: 0 rents the facility out for free; negative is rejected.","required":false,"positionalIndex":-1},{"name":"quantity","type":"integer","description":"For 'job_add': number of runs to queue.","required":false,"positionalIndex":-1},{"name":"recipe_id","type":"string","description":"Recipe ID to run (for 'job_add' action).","required":false,"positionalIndex":-1},{"name":"source","type":"string","description":"Input source for 'job_add': where inputs/credits are pulled from. Same values as deliver_to; defaults to deliver_to.","required":false,"positionalIndex":-1},{"name":"username","type":"string","description":"For 'personal_visit': username of the player whose quarters to visit. Omit to visit your own.","required":false,"positionalIndex":-1}],
    isAmbiguous: false,
  }],
