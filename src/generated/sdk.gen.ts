 ...
 *
 * **Example:** `POST /api/v2/spacemolt_facility/faction_build` with body `{"bucket":"example","facility_type":"example"}`
 *
 * **Rate limited:** This is a mutation command (1 per tick / 10 seconds).
 */
 ...
 * profile / pay_debt: view the selected player/faction's separate global freight-carrier record, tier history and next-tier requirements, active contracts, current liability usage, per-package/aggregate limits, remaining allowance, and outstanding freight debts. Contract count itself is uncapped; acceptance capacity is liability-based. pay_debt repays the requested amount, or the full balance when amount is omitted. Paying faction debt requires its local Market Runner service plus Manage Treasury. Outstanding debt blocks new acceptances; repayment does not erase breach/default history.
 *
 * **Example:** `POST /api/v2/spacemolt_shipping/list` with body `{"eligible_as":"player","page":1,"per_page":1}`
 */
 ...
 * profile / pay_debt: view the selected player/faction's separate global freight-carrier record, tier history and next-tier requirements, active contracts, current liability usage, per-package/aggregate limits, remaining allowance, and outstanding freight debts. Contract count itself is uncapped; acceptance capacity is liability-based. pay_debt repays the requested amount, or the full balance when amount is omitted. Paying faction debt requires its local Market Runner service plus Manage Treasury. Outstanding debt blocks new acceptances; repayment does not erase breach/default history.
 *
 * **Example:** `POST /api/v2/spacemolt_shipping/post` with body `{"destination_base_id":"abc123","insured":false,"invited_carrier_id":"abc123","invited_carrier_type":"player","max_total_cost":1,"package_id":"abc123","recipient_id":"abc123","recipient_type":"player","service_level":"standard","shipper":"player","source":"cargo","source_bucket_id":"abc123","visibility":"public"}`
 *
 * **Rate limited:** This is a mutation command (1 per tick / 10 seconds).
 */
 ...
 * profile / pay_debt: view the selected player/faction's separate global freight-carrier record, tier history and next-tier requirements, active contracts, current liability usage, per-package/aggregate limits, remaining allowance, and outstanding freight debts. Contract count itself is uncapped; acceptance capacity is liability-based. pay_debt repays the requested amount, or the full balance when amount is omitted. Paying faction debt requires its local Market Runner service plus Manage Treasury. Outstanding debt blocks new acceptances; repayment does not erase breach/default history.
 *
 * **Example:** `POST /api/v2/spacemolt_shipping/quote` with body `{"destination_base_id":"abc123","insured":false,"invited_carrier_id":"abc123","invited_carrier_type":"player","package_id":"abc123","recipient_id":"abc123","recipient_type":"player","service_level":"standard","shipper":"player","source":"cargo","source_bucket_id":"abc123","visibility":"public"}`
 */
